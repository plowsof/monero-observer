...
layout: post
category: story
title: P2Pool v1.4 released
description: P2Pool decentralized Monero mining pool v1.4 has been released.
tags: mining
image: 
---

*P2Pool* version 1.4[^0] has been released with the following changes:
...
Although P2Pool should work with the official Monero CLI and GUI v0.17.2.3, it is recommended to use it with the newest v0.17.3.0[^1] release.
...
[^0]: [https://github.com/SChernykh/p2pool/releases/tag/v1.4](https://github.com/SChernykh/p2pool/releases/tag/v1.4){:target="_blank"}{:rel="nofollow"}
[^1]: [/monero-v0.17.3.0-oxygen-orion-point-release-p2pool-support](/monero-v0.17.3.0-oxygen-orion-point-release-p2pool-support)
