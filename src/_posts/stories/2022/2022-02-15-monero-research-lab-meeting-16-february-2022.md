...
layout: post
category: story
title: Monero Research Lab meeting scheduled for 16 February 2021 1700 UTC
description: Monero Research Lab meeting scheduled for 16 February 2021 1700 UTC on irc/Matrix channels.
tags: [events, calendar]
meeting_name: MRL
meeting_date: 2022-02-16 (WED)
...
meeting_logs: https://github.com/monero-project/meta/issues/665#issuecomment-1041939483
last_modified_at: 2022-02-16
---

The next Monero Research Lab[^1] meeting is scheduled to take place on Wednesday, February 16th 2022 at 17:00 UTC.
...
This meeting's chairperson will be UkoeHB[^17]. To view the full discussion topic list and propose an agenda item, post a comment on Github in #665[^18].

Logs for the previous MRL meeting are available on Github[^19].

---

**Update: logs for this meeting are available on GH[^20].**

**Meeting notes:**

- back and forth discussion related to mining pools/centralization issues (ongoing)
- we are almost ready for the next HF; other (brief) mentions of PR's
...
[^18]: [https://github.com/monero-project/meta/issues/665](https://github.com/monero-project/meta/issues/665){:target="_blank"}{:rel="nofollow"}
[^19]: https://github.com/monero-project/meta/issues/662#issuecomment-1034041482
[^20]: https://github.com/monero-project/meta/issues/665#issuecomment-1041939483
